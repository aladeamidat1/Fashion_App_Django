...
# MySQL Configuration (commented for now - uncomment when MySQL is set up)
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.mysql',
#         'NAME': os.getenv('DB_NAME', 'fashion_app_db'),
...
DJOSER = {
    'LOGIN_FIELD': 'username',  # Changed to username for simplicity
    'USER_CREATE_PASSWORD_RETYPE': False,  # Disabled for simplicity
    'USERNAME_CHANGED_EMAIL_CONFIRMATION': False,  # Disabled for development
    'PASSWORD_CHANGED_EMAIL_CONFIRMATION': False,  # Disabled for development
    'SEND_CONFIRMATION_EMAIL': False,  # Disabled for development
    'SET_USERNAME_RETYPE': False,  # Disabled for development
